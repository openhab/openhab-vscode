...
import { Disposable, workspace, Uri, Diagnostic } from "vscode";

import { StreamInfo, LanguageClient, LanguageClientOptions, TransportKind, ServerOptions } from "vscode-languageclient";
