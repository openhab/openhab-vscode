...
describe('Tests for item completion', () => {
    ...
    test('.event', () => {
        ...
        completion.event({
            type: 'message',
            data: '{"topic":"smarthome/items/MC_Wohnzimmer_Volume/state","payload":"{\\"type\\":\\"Decimal\\",\\"value\\":\\"93\\"}","type":"ItemStateEvent"}',
            lastEventId: '',
        ...
        completion.event({
            type: 'message',
            data: '{"topic":"smarthome/items/TestItem/added","payload":"{\\"type\\":\\"String\\",\\"name\\":\\"TestItem\\",\\"label\\":\\"lala\\",\\"tags\\":[],\\"groupNames\\":[]}","type":"ItemAddedEvent"}',
            lastEventId: '',
            origin: 'http://openhabianpi.local:8080',
        })
        ...
        completion.event({
            type: 'message',
            data: '{"topic":"smarthome/items/TestItem/updated","payload":"[{\\"type\\":\\"String\\",\\"name\\":\\"TestItem\\",\\"label\\":\\"l1ala\\",\\"tags\\":[],\\"groupNames\\":[]},{\\"type\\":\\"String\\",\\"name\\":\\"TestItem\\",\\"label\\":\\"lala\\",\\"tags\\":[],\\"groupNames\\":[]}]","type":"ItemUpdatedEvent"}',
            lastEventId: '',
            origin: 'http://openhabianpi.local:8080',
        })
        expect(completion.items.size).toBe(1)
        ...
        completion.event({
            type: 'message',
            data: '{"topic":"smarthome/items/TestItem/state","payload":"{\\"type\\":\\"String\\",\\"value\\":\\"BlaBla\\"}","type":"ItemStateEvent"}',
            lastEventId: '',
            origin: 'http://openhabianpi.local:8080',
        })
        // update item
        ...
        completion.event({
            type: 'message',
            data: '{"topic":"smarthome/items/TestItem/statechanged","payload":"{\\"type\\":\\"String\\",\\"value\\":\\"lala\\",\\"oldType\\":\\"String\\",\\"oldValue\\":\\"blabla\\"}","type":"ItemStateChangedEvent"}',
            lastEventId: '',
            origin: 'http://openhabianpi.local:8080',
        })
        ...
        completion.event({
            type: 'message',
            data: '{"topic":"smarthome/items/TestItem/removed","payload":"{\\"type\\":\\"String\\",\\"name\\":\\"TestItem\\",\\"label\\":\\"lala\\",\\"tags\\":[],\\"groupNames\\":[]}","type":"ItemRemovedEvent"}',
            lastEventId: '',
            origin: 'http://openhabianpi.local:8080',
        })
        expect(completion.items.size).toBe(0)
